        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              //     for (int i = 0; i < (shoallmarkermodal?.positions?.length ?? 0); i++) ...[
              // htmlString = (shoallmarkermodal?.positions?[i].properties?.description).toString();
              ...
              //                       child: CachedNetworkImage(
              //                         imageUrl:
              //                         (shoallmarkermodal?.positions?[i].properties?.postImage).toString() ,
              //                         fit: BoxFit.cover,
              //                         progressIndicatorBuilder:
              ...
              //                                 width: 46.w,
              //                                 child: Text(
              //                                   shoallmarkermodal?.positions?[i].properties?.title==""||shoallmarkermodal?.positions?[i].properties?.title==null?"N/A":(shoallmarkermodal?.positions?[i].properties?.title).toString(),
              //                                   maxLines: 1,
              //                                   style: TextStyle(
              ...
              //                                 width: 40.w,
              //                                 child: Text(
              //                                   shoallmarkermodal?.positions?[i].properties?.description==""||shoallmarkermodal?.positions?[i].properties?.description==null?"N/A" :(shoallmarkermodal?.positions?[i].properties?.description).toString(),
              //                                   maxLines: 1,
              //                                   style: TextStyle(
              //                                       overflow:
              ...
              //                               SizedBox(width: 2.w),
              //                               Text(
              //                                 shoallmarkermodal?.positions?[i].properties?.onlyAvg==""||shoallmarkermodal?.positions?[i].properties?.onlyAvg==null?"N/A" :(shoallmarkermodal?.positions?[i].properties?.onlyAvg).toString(),
              //                                 maxLines: 1,
              //                                 style: TextStyle(
              //                                   overflow: TextOverflow.ellipsis,
              //                                   fontSize: 13.sp,
              ...
              //                               title: "View Details",
              //                               route: () {
              //                                 Get.to(DetailsScreen(postid:(shoallmarkermodal?.positions?[i].properties?.postId).toString() ,));
              //                               },
              //                               hight: 6.h,
              //                               width: 40.w,
              //                               txtsize: 15.sp)
