...
class ViewAllOtherDetilsScreen extends StatefulWidget {
  String? postid;

  ViewAllOtherDetilsScreen({super.key, this.postid});

  @override
  State<ViewAllOtherDetilsScreen> createState() => _ViewAllOtherDetilsScreenState();
}
...
class _ViewAllOtherDetilsScreenState extends State<ViewAllOtherDetilsScreen> {
