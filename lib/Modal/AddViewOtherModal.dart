class AddViewOtherModal {
  ...
  AddViewOtherModal.fromJson(Map<String, dynamic> json) {
...
class WpestateDetailedViews {
  ...
  WpestateDetailedViews({this.i06072024});

  WpestateDetailedViews.fromJson(Map<String, dynamic> json) {
    i06072024 = json['06-07-2024'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['06-07-2024'] = this.i06072024;
    return data;
  }
}
