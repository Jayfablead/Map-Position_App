...
class ViewOterDetailsScreen extends StatefulWidget {
  ...
  ViewOterDetailsScreen({super.key, this.postid});

  @override
  State<ViewOterDetailsScreen> createState() => _ViewOterDetailsScreenState();
}
...
class _ViewOterDetailsScreenState extends State<ViewOterDetailsScreen> {
