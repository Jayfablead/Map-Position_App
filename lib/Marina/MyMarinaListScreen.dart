                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        // deleteposition((mymarinaviewmodal?.positions?[i].properties ?.postId)?.toString() ?? "");
                                        mymarinaviewmodal?.positions?[i].properties?.termName==null?Get.to(AddAchoragePositionScreen(lat:lat1.toString(),lng: lng1.toString(),postid:(mymarinaviewmodal?.positions?[i].properties ?.postId)?.toString() ?? "" ,)): mymarinaviewmodal?.positions?[i].properties?.termName=="Other"?Get.to(AddOtherPositionScreen(lat:lat1.toString(),lng: lng1.toString(),postid:(mymarinaviewmodal?.positions?[i].properties ?.postId)?.toString() ?? "" ,)): mymarinaviewmodal?.positions?[i].properties?.termName=="Warning"?Get.to(AddWarningScreen(lat:lat1.toString(),lng: lng1.toString(),postid:(mymarinaviewmodal?.positions?[i].properties ?.postId)?.toString() ?? "" ,)):Get.to(AddAchoragePositionScreen(lat:lat1.toString(),lng: lng1.toString(),postid:(mymarinaviewmodal?.positions?[i].properties ?.postId)?.toString() ?? "" ,));
                                      },
                                      child: Container(
                                        width: 10.w,
                                        height: 10.w,
